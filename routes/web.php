...
Route::group(['middleware' => ['common', 'auth', 'active']], function() {
    ...
    Route::controller(CategoryController::class)->group(function () {
        ...
        // Department routes (under Category)
        Route::get('category-department', 'categoryDepartment')->name('category-department.index');
        Route::post('category-department/store', 'storeDepartment')->name('category-department.store');
        Route::put('category-department/update/{id}', 'updateDepartment')->name('category-department.update');
        Route::get('category-department/{id}/edit', 'editDepartment')->name('category-department.edit');
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::get('customers/black-list-customers', 'black_list_customers')->name('customer.blackListCustomers');
        Route::get('delete-black-list-customer/{id}', 'delete_black_list_customer')->name('customer.deleteBlackListCustomers');
         Route::get('/customer/check-customer-status/{whatsapp_number}', 'customer_status')->name('customer.status');

         //Store Customer From Pos Modal use storeCustomer function
        Route::post('customer/store-customer', 'storeCustomer')->name('customer.storeCustomer');
    });
    ...
    Route::controller(SaleController::class)->group(function () {
        ...
        Route::get('ads', 'ads')->name('ads.index');
        Route::get('create-ad', 'createAd');
        Route::post('store-ad', 'storeAd')->name('ad.store');
    ...
    Route::controller(HirePurchaseController::class)->group(function () {
        Route::prefix('hire-purchase')->group(function () {
            Route::get('/', 'index')->name('hire_purchase.index');
            Route::get('dashboard', 'dashboard')->name('hire_purchase.dashboard');
            Route::get('pending', 'pending')->name('hire_purchase.pending');
            Route::get('overdue', 'overdue')->name('hire_purchase.overdue');
            Route::get('show/{id}', 'show')->name('hire_purchase.show');
            Route::get('get-installments', 'getInstallments')->name('hire_purchase.get_installments');
            Route::post('record-payment/{id}', 'recordPayment')->name('hire_purchase.record_payment');
            Route::get('report', 'report')->name('hire_purchase.report');
            Route::post('export-report', 'exportReport')->name('hire_purchase.export_report');
        });
    });
    ...
    Route::controller(PurchaseController::class)->group(function () {
        Route::prefix('purchases')->group(function () {
            ...
            //Authorize payment
            Route::post('authorize_payment/{id}', 'authorizePayment')->name('purchase.authorize-payment');
            //getPaymentData using id
            Route::get('get_payment_data/{id}', 'getPaymentData')->name('purchase.getPaymentData');
            ...
            Route::post('approve-payment/{id}', 'approvePayment')->name('purchase.approve-payment');
            Route::post('reject-payment/{id}', 'rejectPayment')->name('purchase.reject-payment');
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::prefix('report')->group(function () {
            ...
            Route::match(['get','post'], 'report/warehouse-stock', [ReportController::class, 'warehouseStockReport'])->name('report.warehouseStockReport');
            ...
            Route::get('daily_purchase/{year}/{month}', 'dailyPurchase')->name('report.dailyPurchase');
            ...
            Route::any('profit_loss_data', 'profitLossData')->name('report.profitLossData');
    ...
    Route::controller(ExpenseController::class)->group(function () {
        ...
        Route::post('expenses/{id}/authorize', 'authorizeExpense')->name('expenses.authorize');
