...
<div class="page-wrapper">
   ...
   @include('reusables.header')
    ...
    <div class="login-section">
      <div class="image-layer" style="background-image: url(<?php echo url('/')?>/board2/images/background/12.jpg);"></div>
      <div class="outer-box">
        <!-- Login Form -->
        <div class="login-form default-form">
          <div class="form-inner">
              <center>
               <div class="logo-box">
              <div class="logo"><a href="{{url('/')}}"><img src="https://admin.dailyfairgh.com/logo/20231120015906.png" alt="" title=""></a></div>
            </div>
            <h3>{{env('APP_NAME')}}</h3>
            </center>
