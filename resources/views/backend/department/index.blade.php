                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <button type="button" data-id="{{$department->id}}" data-name="{{$department->name}}" class="edit-btn btn btn-link edit-department" data-toggle="modal" data-target="#editModal" data-action="{{ route('departments.update', $department->id) }}" ><i class="dripicons-document-edit"></i>  {{trans('file.edit')}}</button>
                                </li>
                                <li class="divider"></li>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
        {{ Form::open(['route' => ['departments.update', 1], 'method' => 'PUT', 'id' => 'editForm']) }}
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label>{{ trans('file.name') }} *</label>
            {{ Form::text('name', null, ['required' => 'required', 'class' => 'form-control', 'id' => 'edit_name']) }}
        </div>
