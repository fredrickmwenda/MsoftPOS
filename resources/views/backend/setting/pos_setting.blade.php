                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 d-flex justify-content-between">
                                    ...
                                    <div class="form-group d-inline">
                                        ...
                                        <input class="mt-2" type="checkbox" name="options[]" value="mobile_money" checked>
                                        @else
                                        <input class="mt-2" type="checkbox" name="options[]" value="mobile_money">
                                        @endif
                                        <label class="mt-2"><strong>Mobile Money</strong></label>
                                    </div>
