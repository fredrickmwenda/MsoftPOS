                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 d-none">
                                    <div class="form-group">
                                        ...
                                        <div class="row ml-1">
                                            <div class="col-md-3 theme-option" data-color="default.css" style="background: #13bd60; min-height: 40px; max-width: 50px;" title="Purple"></div>&nbsp;&nbsp;
                                ...
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Sales person whatsapp number</label>
                                        <input type="text" name="whatsapp_number" class="form-control" value="{{$lims_general_setting_data->whatsapp_number}}">
                                    </div>
                                </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Support Email</label>
                                        <input type="text" name="support_email" class="form-control" value="{{$lims_general_setting_data->support_email}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
