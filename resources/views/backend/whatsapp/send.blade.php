        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4>{{ __('file.send_whatsapp_message') }}</h4>
                </div>
                <div class="card-body">
                    {{-- Form Start --}}
                    <form method="POST" action="{{ route('whatsapp.send') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                    ...
                                    @foreach ($receivers as $group => $items)
                                        <optgroup label="{{ $group }}">
                                            ...
                                            <option class="select-all text-success" data-group="{{ $group }}"
                                                value="">{{ __('file.Select All') }}</option>
                            ...
                            {{-- Template --}}
                            <div class="col-md-6 form-group">
                                <label>{{ __('file.template') }}</label>
                                <select name="template_info" class="form-control selectpicker" data-live-search="true">
                                    <option value="">{{ __('file.no_template_type_message') }}</option>
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea id="messageInput" name="message" class="form-control" rows="3"
                                        placeholder="{{ __('file.type_your_message') }}"></textarea>
                                </div>
                            </div>

                            <!-- Attachment -->
                            <div class="col-md-12 form-group">
                                <label>{{ __('file.attachment') }}</label><br>
                                <div class="btn-group">
