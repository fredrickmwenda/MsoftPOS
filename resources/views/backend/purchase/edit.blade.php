                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="text" id="bill_no" name="bill_no" value="{{$lims_purchase_data->bill_no}}">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <div class="search-box input-group">
                                            <select name="product_code_name" id="lims_productcodeSearch" class="form-control selectpicker" data-live-search="true" title="Select Product">
                                                <option value=""></option>
                                                @foreach($lims_product_list_without_variant as $product)
                                                    <option value="{{ $product->code }}">{{ $product->code }} | {{ $product->name }}</option>
                                                @endforeach
                                                @foreach($lims_product_list_with_variant as $product)
                                                    <option value="{{ $product->item_code }}">{{ $product->item_code }} | {{ $product->name }}</option>
                                                @endforeach
                                            </select>
                                            <button type="button" class="btn btn-secondary" title="Add Product"><i class="fa fa-plus"></i></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-5">
