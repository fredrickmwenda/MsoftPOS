                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Whatsapp Number <span id="_status"></span> <span id="_check"></span></label>
                                    <input type="number" id="whatsapp_number" name="whatsapp_number" onchange="checkStatus()" placeholder="+233 76 789998" class="form-control">
...
<script type="text/javascript">
    ...
    function checkStatus() {
        ...
        $.ajax({
                        type: 'GET',
                         url: "./check-customer-status/" + whatsapp_number,
                        dataType: 'json',
                        success: function(response) {
                            // Assuming the response has a key 'units' containing an array of units
                           if(response.status==0){
                            $('#_status').html('<span class="badge bg-success">Good Customer</span>');
                           }else if(response.status==1){
                             $('#_status').html('<span class="badge bg-danger">Bad Customer</span>');
                           }

                          if(response.exist==1){
                             $('#_checks').html('<span class="badge bg-danger">Customer Exists</span>');
                           }
