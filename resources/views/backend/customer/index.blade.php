            ...
            <tbody>
                ...
                <tr data-id="{{$customer->id}}">
                    ...
                    <td>
                        ...
                        <br>{{$customer->address}},{{$customer->location}} {{$customer->city}},{{$customer->region}}@if($customer->country) {{','.$customer->country}}@endif
                    </td>
                  <!--  <td>
                        ...
                        @else
                        <span class="badge bg-info">Not rated</span>
                        @endif
                    </td>-->
                    <td>
