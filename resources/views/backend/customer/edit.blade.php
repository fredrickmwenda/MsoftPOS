                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="whatsapp_number" value="{{$lims_customer_data->whatsapp_number}}" placeholder="21121231231" class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select required class="form-control selectpicker" name="customer_group_id">
                                        ...
                                        @if($customer_group->id==$lims_customer_data->customer_group_id)
                                        <option value="{{$lims_customer_data->customer_group_id}}">{{$customer_group->name}}</option>
                                        @endif
                            ...
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('file.Region')}}</label>
                                    <input type="text" name="region" value="{{$lims_customer_data->region}}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('file.Location')}}</label>
                                    <input type="text" name="location" value="{{$lims_customer_data->location}}" class="form-control">
                                </div>
                            </div>
                             <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('file.Community')}}</label>
                                    <input type="text" value="{{$lims_customer_data->community}}" name="community" class="form-control">
                                </div>
                            </div>
                               <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select required class="form-control selectpicker" id="customer-group-id" name="customer_group_id">
                                            ...
                                            <option @if($lims_customer_data->status=="1") selected @endif value="1">Good</option>
                                            <option @if($lims_customer_data->status=="0") selected @endif value="0">Bad</option>
                                    </select>
                                </div>
                            </div>
