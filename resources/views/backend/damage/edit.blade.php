                                            ...
                                            <div class="form-group">
                                                ...
                                                <select required id="warehouse_id" name="warehouse_id" class="form-control">
                                                    @foreach($lims_warehouse_list as $warehouse)
                                                        <option value="{{ $warehouse->id }}" @if($lims_damage_data->warehouse_id == $warehouse->id) selected @endif>
                                                            {{ $warehouse->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>{{ __('file.Available Quantity') }}</th>
                                                            <th>{{ __('file.Damage Quantity') }}</th>
                                                            <th>{{ __('file.Adjust Quantity') }}</th>
