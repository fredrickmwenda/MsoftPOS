...
<section class="forms"><div class="container-fluid"><div class="activation-shell"><div class="card activation-card">
    ...
    <form method="POST" action="{{ route('accounting.activation.activate') }}" id="activation-form">@csrf
        <div class="wizard-panel active" data-step="1">
            ...
            <p class="wizard-copy">This determines whether we  create an opening balance journal from your existing operational data.</p>
            <div class="row">
                <div class="col-lg-6 mb-3"><label class="business-option {{ $mode === 'existing_business' ? 'selected' : '' }}">
                    ...
                    <p>You already have transactions, stock, customers, suppliers, or balances in MsoftPos. MsoftPos will verify your current data, calculate opening balances, create one Opening Balance Journal, and start double-entry accounting from today.</p>
                </label></div>
        ...
        <div class="wizard-panel" data-step="2">
            ...
            <p class="wizard-copy">MsoftPos checked the operational data needed to initialize accounting safely.</p>
