<?php
    ...
    $designations_active   = $role_has_permissions_list->where('name', 'designs')->first();
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white border rounded shadow-sm mt-3 mx-3">
        <div class="container-fluid" style="background: #fffcf2">
            ...
            <a class="navbar-brand font-weight-bold text-primary" href="{{ route('hrm-panel') }}">
                <i class="dripicons-wallet mr-2"></i> {{ __("file.HRM") }}
            </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('employees.index') ? 'active' : '' }}"
                           href="{{ route('employees.index') }}">
                            <i class="dripicons-clock mr-1"></i> {{ __("file.Employees") }}
                        </a>
                    </li>
                    @endif
                    @if($payroll_active)
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('payroll.index') ? 'active' : '' }}"
                           href="{{ route('payroll.index') }}">
                            <i class="dripicons-wallet mr-1"></i> {{ __("file.Payroll") }}
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('attendance.index') ? 'active' : '' }}"
                           href="{{ route('attendance.index') }}">
                            <i class="dripicons-time-reverse mr-1"></i> {{ __("file.Attendance") }}
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('leave-type.index') ? 'active' : '' }}"
                           href="{{ route('leave-type.index') }}">
                            <i class="dripicons-briefcase mr-1"></i> {{ __("file.Leave Type") }}
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('leave.index') ? 'active' : '' }}"
                           href="{{ route('leave.index') }}">
                            <i class="dripicons-to-do mr-1"></i> {{ __("file.Leaves") }}
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('holidays.index') ? 'active' : '' }}"
                           href="{{ route('holidays.index') }}">
                            <i class="dripicons-calendar mr-1"></i> {{ __("file.Holiday") }}
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('shift.index') ? 'active' : '' }}"
                           href="{{ route('shift.index') }}">
                            <i class="dripicons-calendar mr-1"></i> {{ __("file.Shift") }}
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('overtime.index') ? 'active' : '' }}"
                           href="{{ route('overtime.index') }}">
                            <i class="dripicons-briefcase mr-1"></i> {{ __("file.Overtime") }}
                        </a>
                    </li>
                    @endif
                </ul>
