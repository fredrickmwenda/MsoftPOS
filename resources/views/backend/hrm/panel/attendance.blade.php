    ...
    <div class="container-fluid mt-4">
        ...
        <div class="mb-3 d-flex">
            <button class="btn btn-info mr-2" data-toggle="modal" data-target="#createModal">
                <i class="dripicons-plus"></i> {{ __('file.Add Attendance') }}
            </button>
            ...
            <button class="btn btn-secondary" type="button" data-toggle="collapse" data-target="#importCsv"
                ...
                <i class="fa fa-upload"></i> {{ __('file.Import CSV') }}
            </button>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3 d-flex align-items-end">
                                <button type="submit" class="btn btn-primary mr-2">
                                    <i class="fa fa-check-square-o"></i> {{ __('file.Save') }}
                                </button>
                    ...
                    <tr data-date="{{ $attendance['date'] }}" data-employee_id="{{ $attendance['employee_id'] }}">
                        ...
                        <td>
                            @if ($attendance['status'])
                                <span class="badge badge-success">{{ __('file.Present') }}</span>
                            @else
                                <span class="badge badge-danger">{{ __('file.Late') }}</span>
                            @endif
                        </td>
