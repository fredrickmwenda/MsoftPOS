    ...
    <div role="document" class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{ __('file.Update Sale Agent') }}</h5>
            ...
            <div class="modal-body">
                    ...
                    <div class="col-md-12 mt-4">
                        ...
                        <div id="edit-sale-agent-section" class="border p-3 rounded">
                            ...
                            <button type="button" class="btn btn-success mt-2"
                                id="edit-add-more">{{ __('file.Add More') }}</button>
                        </div>
                    </div>
                ...
                <div class="form-group mt-4">
                    <button type="submit" class="btn btn-primary" id="submit">{{ __('file.submit') }}</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
