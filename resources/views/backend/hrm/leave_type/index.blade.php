...
<section>
    <div class="container-fluid">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModal">
            <i class="dripicons-plus"></i> {{__('file.Add Leave Type')}}
        </button>
    </div>
        ...
        <table id="leave-type-table" class="table">
            <thead>
                <tr>
                    ...
                    <th>{{__('file.name')}}</th>
                    <th>{{__('file.Annual Quota')}} </th>
                    <th>{{__('file.paid_or_unpaid')}}</th>
                    <th>{{__('file.Carry Forward Limit')}} </th>
                    ...
                    <td>
                        <div class="btn-group">
                            <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                {{__('file.action')}} <span class="caret"></span>
                            </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>{{__('file.name')}} 
                        <i class="dripicons-information" data-toggle="tooltip" data-placement="right" title="Example: Casual Leave, Sick Leave, Earned Leave"></i>
                    </label>
                    {{ Form::text('name', null, ['class'=>'form-control','required'=>true]) }}
                </div>

                <div class="form-group">
                    <label>{{__('file.Annual Quota')}} 
                        <i class="dripicons-information" data-toggle="tooltip" data-placement="right" title="Total number of leave days allowed for this type per year"></i>
                    </label>
                    {{ Form::number('annual_quota', null, ['class'=>'form-control','required'=>true]) }}
                </div>

                <div class="form-group">
                    <label>{{__('file.paid_or_unpaid')}} 
                        <i class="dripicons-information" data-toggle="tooltip" data-placement="right" title="Select Yes if paid leave, No if unpaid"></i>
                    </label>
                    {{ Form::select('encashable', [1=>'Yes',0=>'No'], null, ['class'=>'form-control','required'=>true]) }}
                </div>

                <div class="form-group">
                    <label>{{__('file.Carry Forward Limit')}} 
                        <i class="dripicons-information" data-toggle="tooltip" data-placement="right" title="Maximum number of days that can be carried forward to next year"></i>
                    </label>
...
<div id="editModal" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5>{{__('file.Update Leave Type')}}</h5>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group">
            <label>{{__('file.name')}} 
                <i class="dripicons-information" data-toggle="tooltip" data-placement="right" title="Enter new name to update leave type"></i>
            </label>
        ...
        <div class="form-group">
            <label>{{__('file.Annual Quota')}} 
                <i class="dripicons-information" data-toggle="tooltip" data-placement="right" title="Update the annual quota for this leave type"></i>
            </label>
        ...
        <div class="form-group">
            <label>{{__('file.paid_or_unpaid')}} 
                <i class="dripicons-information" data-toggle="tooltip" data-placement="right" title="Yes = Paid leave, No = Unpaid leave"></i>
            </label>
        ...
        <div class="form-group">
            <label>{{__('file.Carry Forward Limit')}} 
                <i class="dripicons-information" data-toggle="tooltip" data-placement="right" title="Update maximum carry forward days"></i>
            </label>
        ...
        <div class="form-group">
            <input type="submit" value="{{__('file.Update')}}" class="btn btn-primary">
        </div>
      </div>
      {{ Form::close() }}
    </div>
