...
<body>
    ...
    <div id="documenter_content">
        ...
        <section id="product">
            ...
            <p>You can add, edit and delete product department. You can also import category from CSV file and export table data to PDF, Excel, CSV. Also you can print data from table.</p>
            <p>
