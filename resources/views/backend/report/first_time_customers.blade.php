    ...
    <section>
        ...
        <div class="table-responsive">
            <table id="customer-table" class="table">
                ...
                <tbody>
                @foreach($first_time_customers as $key => $customer)
                    @if(isset($customer['name']))
                        <tr>
                            <td>{{ $key }}</td>
                            <td>
                                    <?php
                                    echo $customer['name'] . '<br>Phone: ' . $customer['phone_number'] . '<br>Email: ' . $customer['email'] . '<br>WhatsApp: ' . $customer['whatsapp'];
                                    ?>
                            </td>
                            <td>
                                    <?php
                                    echo $customer['order_date'];
                                    ?>
                            </td>
                        </tr>
                    @endif
