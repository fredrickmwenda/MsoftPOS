        ...
        <div class="col-md-6">
            <div class="input-group">
                <span class="input-group-text border-0 bg-white">
                    <i class="dripicons dripicons-search"></i>
                </span>
                <input type="text" id="reportSearch" class="form-control border-0" placeholder="Search reports...">
            </div>
        </div>
        <div class="col-md-6">
            <select id="reportCategory" class="form-select border-0">
                <option value="">All Categories</option>
                <option value="sales">Sales Reports</option>
                <option value="purchase">Purchase Reports</option>
                <option value="warehouse">Warehouse Reports</option>
    ...
    <div class="report-item" data-category="financial" data-name="Department Report">
        <a href="{{ route('report.department') }}" class="report-link">
            ...
            <div class="alert alert-warning mt-4 d-none text-center" id="noResults">
                <i class="dripicons dripicons-search"></i> No reports found matching your search criteria.
            </div>
        </div>
    </div>
