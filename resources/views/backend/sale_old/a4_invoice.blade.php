...
<html>
    ...
    <body>
        ...
        <table class="table table-bordered" dir="@if( Config::get('app.locale') == 'ar' || $general_setting->is_rtl){{'rtl'}}@endif" style="width: 100%;">
        ...
        <table class="table" style="width: 100%; border-collapse: collapse;margin-top:-9px;">
            <tr>
                <td style="width: 100%; text-align: center; display:inline-block">
                  <center>
                    ...
                    <?php echo '<img style="width:5%; margin-left:30px;" src="data:image/png;base64,' . DNS2D::getBarcodePNG($qrText, 'QRCODE') . '" alt="barcode"   />';?>
                    </center>
                </td>
            ...
            <tr>
                 <td style="width: 100%; text-align: center">
                    {{trans('file.Developed')}} {{trans('file.By')}} <span class="external">{{$general_setting->developed_by}}
                </td>
            </tr>
        </table>
