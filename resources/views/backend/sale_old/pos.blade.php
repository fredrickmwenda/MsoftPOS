...
<section class="forms pos-section">
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:-5px !important;">
            ...
            <div class="col-md-2 order-3 order-md-1" style="background-color: #00172D !important;">
                <div class="row mt-3">
                    ...
                    @if(in_array("card",$options))
                        ...
                        @endif
                        <div class="column-5 col-6">
                            <button style="background: transparent; border-color:#99b3e6;" type="button" class="btn btn-sm btn-custom" id="draft-btn"><i class="dripicons-flag"></i> <br> {{trans('file.Draft')}}</button>
                        </div>
            ...
            <div class="col-md-5 order-2 order-md-2"  style="background-color:#f5f5f0 !important;">
...
{{--                                                    type="button" data-toggle="modal" data-target="#addCustomer"--}}
                                                <a href="{{ url('customer/create') }}" class="btn btn-default btn-sm"><i class="dripicons-plus"></i></a>
                                                @else
                                                <?php
                                                  $deposit = [];
                                                  $points = [];
          ...
          <div class="row mt-2">
                    <div class="col-md-4 col-4">
                        <button class="btn btn-block btn-warning " style="color:#fff;" id="category-filter">{{trans('file.category')}}</button>
                    </div>
                    <div class="col-md-4 col-4">
                        <button class="btn btn-block btn-success" style="color:#fff;" id="brand-filter">{{trans('file.Brand')}}</button>
                    </div>
                    <div class="col-md-4 col-4">
                        <button class="btn btn-block btn-danger" style="color:#fff;" id="featured-filter">{{trans('file.Featured')}}</button>
                    </div>
