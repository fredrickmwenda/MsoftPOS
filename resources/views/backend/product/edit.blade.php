                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="product_barcode" id="product_barcode" class="form-control" placeholder="Scan or enter product barcode" value="{{$lims_product_data->product_barcode}}">
                                            <div class="input-group-append">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="box_barcode" id="box_barcode" class="form-control" placeholder="Scan or enter box barcode" value="{{$lims_product_data->box_barcode}}">
                                            <div class="input-group-append">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          ...
                                          <select name="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Brand/Make...">
                                ...
                                <div id="profit_margin" class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="profit_margin" required class="form-control" step="0.01" value="{{$lims_product_data->profit_margin}}">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="tax_id[]" 
                                            ...
                                            @php
                                                // Get IDs of already selected taxes for this product
                                                $selected_taxes = $lims_product_data->product_taxes->pluck('id')->toArray();
                                            @endphp

                                            @foreach($lims_tax_list as $tax)
                                                <option value="{{ $tax->id }}" 
                                                    {{ in_array($tax->id, old('tax_id', $selected_taxes)) ? 'selected' : '' }}>
                                                    {{ $tax->name }} ({{ $tax->rate }}%)
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="form-check mb-2">
                                            <input type="checkbox" id="input_shelf_option" name="input_shelf_option"
                                                class="form-check-input"
                                                {{ $lims_product_data->input_shelf_option ? 'checked' : '' }}>
                                            <label class="form-check-label" for="input_shelf_option">Input Shelf Option</label>
                                        </div>

                                        <div id="shelf_input_div" style="{{ $lims_product_data->input_shelf_option ? '' : 'display:none;' }}">
                                            <label for="shelf">Shelf</label>
                                            <input type="text" name="shelf" id="shelf" value="{{ $lims_product_data->shelf }}"
                                                class="form-control" placeholder="Enter shelf name">
                                        </div>
                                    </div>
                                </div>
...
@php
    ...
    // Get product_warehouse rows for this product
    $initial_stock = Product_Warehouse::where('product_id', $lims_product_data->id)
                        ->get()
                        ->keyBy('warehouse_id');

    // Show if any warehouse has stock
    $has_initial_stock = $initial_stock->count() > 0;
@endphp


<div class="col-md-4">
    <div class="form-group mt-3">
        <input type="checkbox" name="is_initial_stock" id="toggle-initial-stock" value="1" {{ $has_initial_stock ? 'checked' : '' }}>&nbsp;
        ...
        <p class="italic">{{ trans('file.This feature will not work for product with variants and batches') }}</p>
                                ...
                                <div class="col-md-6" id="initial-stock-section" style="{{ $has_initial_stock ? '' : 'display:none' }}">
                                    <div class="table-responsive ml-2">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                @php
                                                    $qty = $initial_stock[$warehouse->id]->qty ?? 0;
                                                @endphp
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="number" name="stock[]" min="0" class="form-control" value="{{ $qty }}">
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                ...
                                <div class="col-md-12 mt-3" id="batch-option">
                                    ...
                                    {{-- Expiry Input Fields --}}
                                    <div id="ExpiryInput" class="mt-3" style="display: none;">
                                        <div class="form-group">
                                            ...
                                            <input 
                                                ...
                                                value="{{ old('batch_no', $lims_product_data->batch_no ?? '') }}"
                                            >
                                        </div>

                                        <div class="form-group">
                                            <label for="expired_date">Expiry</label>
                                            <input 
                                                type="date" 
                                                name="expired_date" 
                                                id="expired_date" 
                                                class="form-control"
                                                value="{{ old('expired_date', $lims_product_data->expired_date ?? '') }}"
                                            >
                                        </div>
                                    </div>
                                </div>
...
<script> 
    $(document).ready(function () {
        $('#input_shelf_option').on('change', function () {
            if ($(this).is(':checked')) {
                $('#shelf_input_div').show();
            } else {
                $('#shelf_input_div').hide();
                $('#shelf').val(''); // optional: clear input when hidden
            }
        });
    });
 </script>
 <script>
    document.addEventListener('DOMContentLoaded', function() {
        const checkbox = document.getElementById('is-batch');
        ...
        checkbox.addEventListener('change', toggleExpiryFields);
    });
</script>
...
// 🔥 Auto-show on edit if already checked
if ($("input[name='is_initial_stock']").is(':checked')) {
    $("#initial-stock-section").show();
}
