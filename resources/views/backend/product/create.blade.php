                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Barcode Symbiology *</strong> </label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="product_barcode" id="product_barcode" class="form-control" placeholder="Scan or enter product barcode">
                                            <div class="input-group-append">
                                                <button type="button" id="scanProductBarcode" class="btn btn-outline-secondary"><i class="fa fa-barcode"></i></button>
                                            </div>
                                        </div>
                                        <small class="text-muted">Use a barcode scanner or manually enter.</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="box_barcode" id="box_barcode" class="form-control" placeholder="Scan or enter box barcode">
                                            <div class="input-group-append">
                                                <button type="button" id="scanBoxBarcode" class="btn btn-outline-secondary"><i class="fa fa-barcode"></i></button>
                                            </div>
                                        </div>
                                        <small class="text-muted">Scan box-level barcode or enter manually.</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Brand')}}/Make</strong> </label>
                                        <div class="input-group flex-nowrap">
                                            <select name="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Brand/Make..." data-width="85%">
                                                @foreach($lims_brand_list as $brand)
                                                    <option value="{{$brand->id}}">{{$brand->title}}</option>
                                                @endforeach
                                            </select>
                                            <div class="input-group-append">
                                                <a href="#addBrandModal" data-toggle="modal" data-target="#" class="btn btn-default btn-sm ml-0"><i class="dripicons-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="profit_margin" class="col-md-4">
                                     <div class="form-group">
                                        <label>Profit Margin (%)</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Wholesale Price</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="tax_id[]" class="form-control selectpicker" multiple data-live-search="true" title="Select Tax">
                            ...
                            @endforeach
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="toggleShelf">
                                            <label class="form-check-label" for="toggleShelf">
                                                Input shelf option
                                            </label>
                                        </div>
                                    </div>

                                    <div class="form-group" id="shelfInput" style="display: none;">
                                        <label for="shelf">Shelf</label>
                                        <input type="text" name="shelf" id="shelf" class="form-control" placeholder="Enter shelf number">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mt-3" id="batch-option">
                                    ...
                                    <div id="ExpiryInput" class="mt-3">
                                        <div class="form-group">
                                            <ilabel for ="batch_no">Batch No</ilabel>
                                            <input type="text" name="batch_no" id="batch_no" class="form-control" placeholder="Enter Batch No">
                                        </div>
                                        <div class="form-group"  >
                                            <label for="expiry_date">Expiry</label>
                                            <input type="date" name="expired_date" id="shelf" class="form-control" placeholder="Enter Expiry date">
                                        </div>
                                    </div>
                                </div>
...
<div id="addBrandModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        {!! Form::open(['route' => 'brand.store', 'method' => 'post', 'files' => true]) !!}
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{trans('file.Add Brand')}}/Make</h5>
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="form-group">
                ...
                {{Form::text('title',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type brand/make title...'))}}
            </div>
            <div class="form-group">
...
document.addEventListener('DOMContentLoaded', function() {
    const productInput = document.getElementById('product_barcode');
    const boxInput = document.getElementById('box_barcode');

    // Auto focus product barcode first
    productInput.focus();

    // When a barcode is scanned (scanner sends Enter), move to box field
    ...
    // Optional: when box barcode scanned, move to next input (like price)
    ...
    // Optional scan button (manual trigger for camera scanning)
    document.getElementById('scanProductBarcode').addEventListener('click', function() {
        alert('If using a barcode scanner, place cursor in field and scan.');
    });
    document.getElementById('scanBoxBarcode').addEventListener('click', function() {
        alert('Place cursor in box barcode field and scan.');
    });
});
</script>

<script type="text/javascript">
   document.getElementById('toggleShelf').addEventListener('change', function() {
        const shelfDiv = document.getElementById('shelfInput');
        shelfDiv.style.display = this.checked ? 'block' : 'none';
    });
    ...
    $("input[name='is_batch']").on("change", function () {
        if ($(this).is(':checked')) {
            ...
            $("#ExpiryInput").show(300);
        }
        else{
            $("#variant-option").show(300);
            $("#ExpiryInput").hide(300);
        }
    });
    ...
    myDropzone = new Dropzone('div#imageUpload', {
        ...
        init: function () {
            var myDropzone = this;
             // Attach sortable only after Dropzone is ready
            $(".dropzone").sortable({
                items: '.dz-preview',
                cursor: 'grab',
                opacity: 0.5,
                    ...
                    $('#imageUpload .dz-preview .dz-filename [data-dz-name]').each(function (count, el) {
                        ...
                        queue.forEach(function (file) {
                            ...
                            if (file.upload && file.upload.filename) {
                                uploadedName = file.upload.filename;
                            } else if (file.name) {
                                uploadedName = file.name;
                            }

                            if (uploadedName === displayName) {
                                newQueue.push(file);
                            }
                        });
                    });

                    // Only replace if there’s a valid new queue
        ...
        //           }
        //       } catch (error) {
        //           console.error("Dropzone parsing error:", error);
        //       }
        //     }
        // },
        error: function (file, response) {
