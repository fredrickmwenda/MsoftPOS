                ...
                <div class="table-responsive transaction-list">
                    <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                        <thead class="d-md-table-header-group">
                            <tr>
                                <th class="col-sm-5 col-6">{{ __('file.product') }}</th>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        <div class="d-flex justify-content-between">
                            <strong class="totals-title">{{ __('file.Items') }}</strong>
                            <strong id="item"></strong>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="d-flex justify-content-between">
                            <strong class="totals-title">{{ __('file.Total') }}</strong>
                    ...
                    <div class="col-sm-6 col-md-3 mt-3">
                        <div class="d-flex flex-column">
                            <strong class="totals-title">{{ __('file.Discount') }}</strong>
                            <strong id="discount" class="d-block"></strong>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 mt-3">
                        <div class="d-flex flex-column">
                            <strong class="totals-title">{{ __('file.Coupon') }}</strong>
                            <strong id="couponText" class="d-block"></strong>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 mt-3">
                        <div class="d-flex flex-column">
                            <strong class="totals-title">{{ __('file.Tax') }}</strong>
                            <strong id="tax" class="d-block"></strong>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 mt-3">
                        <div class="d-flex flex-column">
                            <strong class="totals-title">{{ __('file.Shipping') }}</strong>
                ...
                <div class="payment-amount d-md-block mt-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            <div class="d-flex flex-column">
                                <strong class="totals-title">{{ __('file.Cash Received') }}</strong>
                                <strong id="CashReceived" class="d-block"></strong>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="d-flex flex-column">
                                <strong class="totals-title">{{ __('file.Total Paying') }}</strong>
                                <strong id="totalPaying" class="d-block"></strong>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="d-flex flex-column">
                                <strong class="totals-title">{{ __('file.Change') }}</strong>
                                <strong id="change" class="d-block"></strong>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="d-flex flex-column">
                                <strong class="totals-title">{{ __('file.Due') }}</strong>
