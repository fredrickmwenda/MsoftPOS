...
@endif
                                ...
                                <!-- Product Search Section (Hidden initially) -->
                                <div class="row mt-3" id="product-search-section" style="display: none;">
                                    <div class="col-md-12">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <input type="checkbox" name="is_hire_purchase" id="is_hire_purchase" value="1">
                                                Enable Hire Purchase
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <!-- Hire Purchase Section -->
                                <div id="hire-purchase-section" style="display: none;" class="mt-4 p-3 border rounded bg-light">
                                    <h5 class="mb-3">Hire Purchase Details</h5>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Down Payment(Minimum 10%) *</label>
                                                <input type="number" name="hire_purchase_down_payment" id="down_payment" class="form-control" step="0.01" min="0" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Payment Terms'(Months) *</label>
                                                <select name="hire_purchase_terms" id="hire_purchase_terms" class="form-control">
                                                    <option value="">Select Terms</option>
                                                    <option value="3" data-rate="5">3 Months (5% Interest)</option>
                                                    <option value="6" data-rate="8">6 Months (8% Interest)</option>
                                                    <option value="12" data-rate="12">12 Months (12% Interest)</option>
                                                    <option value="24" data-rate="15">24 Months (15% Interest)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="hire_purchase_interest_rate" id="interest_rate" class="form-control" step="0.01" readonly />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <p id="monthly-installment" class="ml-2">{{number_format(0, $general_setting->decimal, '.', '')}}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Total Interest</label>
                                                <p id="total-interest" class="ml-2">{{number_format(0, $general_setting->decimal, '.', '')}}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Total with Interest</label>
                                                <p id="total-with-interest" class="ml-2">{{number_format(0, $general_setting->decimal, '.', '')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Hire Purchase Start Date</label>
                                                <input type="text" name="hire_purchase_start_date" id="hp_start_date" class="form-control date" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Installment Schedule Preview</label>
                                                <div id="installment-preview" style="max-height: 200px; overflow-y: auto;">
                                                    <p class="text-muted">Schedule will appear here</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="payment">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" id="mobile-money-fields" style="display: none;">
                                            <div class="form-group">
                                                <label>{{trans('Mobile Money')}} Operator</label>
                                                <select name="mobile-op" class="form-control" data-live-search="true" data-live-search-style="begins" title="Mobile money operator">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        <div class="form-check mb-2">
                                            <input type="checkbox" id="additionalCostCheckbox" class="form-check-input">
                                            <label for="additionalCostCheckbox" class="form-check-label">
                                                {{ trans('file.Additional Cost') }}
                                            </label>
                                        </div>
                                    </div>

                                    <div class="col-md-6" id="additionalCostSection" style="display: none;">
                                        <div id="additionalCostContainer">
                                            <div class="row additional-cost-item mb-2">
                                                <div class="col-md-5">
                                                    <input type="text" name="cost_name[]" class="form-control" placeholder="Enter Cost Name">
                                                </div>
                                                <div class="col-md-5">
                                                    <input type="number" step="0.01" name="cost_amount[]" class="form-control" placeholder="Enter Cost Amount">
                                                </div>
                                                <div class="col-md-2 text-center">
                                                    <button type="button" class="btn btn-success addCostBtn">
...
<script>
 $(document).ready(function () {
    // ✅ Force hide on initial load to prevent flashing
    $('#product-search-section').hide();

    $('select[name="paid_by_id"]').on('change', function () {
        if ($(this).val() == '8') {
            $('#mobile-money-fields').slideDown(300);
        } else {
            $('#mobile-money-fields').slideUp(300);
        }
    });
    
    // Show/hide the additional cost section
    $('#additionalCostCheckbox').on('change', function() {
        if ($(this).is(':checked')) {
            $('#additionalCostSection').slideDown(300);
        } else {
            $('#additionalCostSection').slideUp(300);
        }
    });

    // Add new cost input row dynamically
    $(document).on('click', '.addCostBtn', function() {
        let newRow = `
            <div class="row additional-cost-item mb-2">
                ...
                <div class="col-md-2 text-center">
                    <button type="button" class="btn btn-danger removeCostBtn">
                        <i class="fa fa-minus"></i>
                    </button>
                </div>
            </div>
        `;
        $('#additionalCostContainer').append(newRow);
    });

    // Remove cost row
    $(document).on('click', '.removeCostBtn', function() {
        $(this).closest('.additional-cost-item').remove();
    });
});
</script>
    ...
    $('.customer-submit-btn').on("click", function() {
        $.ajax({
            ...
            success:function(response) {
                ...
                checkSelections(); // Re-check if search can be enabled
            }
        });
    });
...
var row_product_price;
    ...
    // ✅ Strict check: Ensure both Customer and Warehouse are selected
    function checkSelections() {
        var customer_id = $('#customer_id').val();
        var warehouse_id = $('#warehouse_id').val();
        
        if(customer_id && warehouse_id) {
            // Both are selected, show the search bar
            $('#product-search-section').show();
            // ✅ Load products immediately so the dropdown list is ready
            loadWarehouseProducts(); 
        } else {
            // One is missing, hide the search bar and clear it
            $('#product-search-section').hide();
            $('#lims_productcodeSearch').val('');
            lims_product_array = []; // Clear the array
        }
    }

    // ✅ Separate function to load products (mirrors Purchase module exactly)
    function loadWarehouseProducts() {
        ...
        $.ajax({
            type: 'GET',
            url: '{{ route("warehouse.products.sale") }}', // <-- changed
    ...
    // ✅ Use 'changed.bs.select' for Bootstrap Selectpickers
    $('select[name="customer_id"]').on('changed.bs.select', function() {
    ...
    // Trigger check on page load (in case they are pre-selected by the system)
    checkSelections();
...
function productSearch(data) {
    ...
    if(!customer_id || !warehouse_id) {
        alert('Please select both Customer and Warehouse first!');
        $("input[name='product_code_name']").val('');
        return;
    }

    var code_match = data.match(/Code:\s*([^|]+)/);
    var product_code = code_match ? code_match[1].trim() : data.split("|")[0].trim();
    ...
    var ajaxData = product_code + '?' + customer_id + '?' + (parseFloat(pre_qty) + 1);
    ...
    $.ajax({
        ...
        data: {
            data: ajaxData,
            warehouse_id: warehouse_id // ✅ Pass warehouse_id separately
        },
        success: function(data) {
            var flag = 1;
            if (pre_qty > 0) {
            ...
            if(flag){
                ...
                cols += '<td>' + data[1] + '</td>';
                cols += '<td><input type="number" class="form-control qty" name="qty[]" value="'+data[15]+'" required/></td>';
                if(data[12]) {
        ...
        error: function (xhr, ajaxOptions, thrownError) {
            if(xhr.status == 404 || xhr.status == 400) {
                ...
                alert(response.error || 'Product not found in the selected warehouse.');
                $("input[name='product_code_name']").val('');
            }
        }
    });
...
<script>
// ===== HIRE PURCHASE FUNCTIONALITY =====

// Toggle hire purchase section
 $('#is_hire_purchase').on('change', function() {
    if ($(this).is(':checked')) {
        $('#hire-purchase-section').slideDown();
        $('select[name="paid_by_id"]').prop('disabled', true);
        $('#payment').slideUp();
    } else {
        $('#hire-purchase-section').slideUp();
        $('select[name="paid_by_id"]').prop('disabled', false);
        $('#payment').slideDown();
    }
    calculateHirePurchase();
});

// Handle hire purchase terms selection
 $('#hire_purchase_terms').on('change', function() {
    var rate = $('option:selected', this).data('rate');
    $('#interest_rate').val(rate || 0);
    calculateHirePurchase();
});

// Calculate hire purchase on inputs
 $('#down_payment, #hire_purchase_terms, #grand_total').on('input change', function() {
    calculateHirePurchase();
});

// Main hire purchase calculation function
function calculateHirePurchase() {
    ...
    var terms = parseInt($('#hire_purchase_terms').val()) || 0;
    var interestRate = parseFloat($('#interest_rate').val()) || 0;

    // Validate down payment
    var downPaymentPercentage = (downPayment / grandTotal) * 100;
    if ($('#is_hire_purchase').is(':checked') && downPaymentPercentage < 10 && downPayment > 0) {
        showNotification('Down payment must be at least 10% of total amount', 'warning');
    }

    // Calculate balance and interest
    var balance = grandTotal - downPayment;
    var totalInterest = (balance * interestRate) / 100;
    var totalWithInterest = balance + totalInterest;
    var monthlyInstallment = terms > 0 ? (totalWithInterest / terms) : 0;

    // Update display
    $('#monthly-installment').text(monthlyInstallment.toFixed({{$general_setting->decimal}}));
    $('#total-interest').text(totalInterest.toFixed({{$general_setting->decimal}}));
    $('#total-with-interest').text(totalWithInterest.toFixed({{$general_setting->decimal}}));

    // Generate and display installment schedule
    if (terms > 0) {
        generateInstallmentSchedule(downPayment, monthlyInstallment, terms);
    }
}

// Generate installment schedule preview
function generateInstallmentSchedule(downPayment, monthlyInstallment, terms) {
    var startDate = $('#hp_start_date').val() ? moment($('#hp_start_date').val()) : moment();
    var html = '<table class="table table-sm table-bordered"><thead><tr><th>No.</th><th>Due Date</th><th>Amount</th></tr></thead><tbody>';

    for (var i = 1; i <= terms; i++) {
        var dueDate = startDate.clone().add(i, 'months');
        var amount = i === terms ? (monthlyInstallment * terms - (i - 1) * monthlyInstallment) : monthlyInstallment;
        html += '<tr>';
        html += '<td>' + i + '</td>';
        html += '<td>' + dueDate.format('YYYY-MM-DD') + '</td>';
        html += '<td>' + amount.toFixed({{$general_setting->decimal}}) + '</td>';
        html += '</tr>';
    }
...
// Update schedule when start date changes
 $('#hp_start_date').on('change', function() {
    var monthlyInstallment = parseFloat($('#monthly-installment').text()) || 0;
    var terms = parseInt($('#hire_purchase_terms').val()) || 0;
    if (terms > 0 && monthlyInstallment > 0) {
        generateInstallmentSchedule(0, monthlyInstallment, terms);
    }
});

// Notification helper
function showNotification(message, type) {
    // Create a simple notification (you can enhance this with toastr or similar)
    console.warn(message);
}

// Override the grand total calculation to trigger hire purchase recalculation
var originalGrandTotalUpdate = window.updateGrandTotal || function() {};
window.updateGrandTotal = function() {
    originalGrandTotalUpdate();
    if ($('#is_hire_purchase').is(':checked')) {
        calculateHirePurchase();
    }
};
</script>
