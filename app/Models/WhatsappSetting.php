...
class WhatsappSetting extends Model
{
        ...
        try {
            ...
            elseif (in_array($type, ['image', 'document'])) {
                ...
                if (!$uploadResponse->successful()) {
                    return [
                        'success' => false,
                        'message' => __('file.failed_upload_media_whatsApp'),
                ...
                if (!$mediaId) {
                    return [
                        'success' => false,
                        'message' => __('file.media_id_not_returned_from_WhatsApp'),
                    ];
                }
            ...
            return [
                'success' => true,
                'message' => __('file.message_sent_successfully'),
            ];
    ...
    public function getTemplates()
    {
        ...
        return ['error' => __('file.failed_to_fetch_templates')];
    }
    ...
    public function deleteTemplate(string $name)
    {
        ...
        if ($response->successful()) {
            return ['success' => true, 'message' => __('file.template_deleted_successfully')];
        }

        return [
            'success' => false,
            'message' => __('file.failed_delete_template'),
