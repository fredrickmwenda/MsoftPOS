...
class ReturnController extends Controller
{
    ...
    public function getProduct($id)
    {
        ...
        foreach ($lims_product_warehouse_data as $product_warehouse)
        {
            ...
            $lims_product_data = Product::select('code', 'name', 'type', 'is_batch', 'shelf')->find($product_warehouse->product_id);
        ...
        {
            $product_qty[] = $product_warehouse->qty;
            $lims_product_data = Product::select('name', 'type', 'shelf')->find($product_warehouse->product_id);
        ...
        $lims_product_data = Product::select('code', 'name', 'type', 'price', 'shelf')->where('is_active', true)->whereNotIn('type', ['standard'])->get();
