...
class PackingSlipController extends Controller
{
    ...
    public function store(Request $request)
    {
    	...
    	return redirect()->back()->with('message', __('file.Packing slip created successfully'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->back()->with('message', __('file.Packing Slip deletes successfully'));
    }
}
