...
class LeaveController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('message', __('file.Leave request added successfully'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('message', __('file.Leave updated successfully'));
    }
    ...
    public function destroy($id)
    {
        $leave = Leave::findOrFail($id);
        $leave->delete();
        return redirect()->back()->with('message', __('file.Leave deleted successfully'));
    }
    ...
    public function deleteBySelection(Request $request)
    {
        ...
        return response()->json(['message' => __('file.Selected leaves deleted successfully')]);
    }
}
