...
class CustomerController extends Controller
{
    ...
    public function customer_status($whatsapp_number){
        $check=DB::table('black_list_customers')->join('customers','customers.id','=','black_list_customers.customer_id')->where('whatsapp_number','LIKE','%'.$whatsapp_number.'%')->get();
        ...
        $check2=DB::table('customers')->where('whatsapp_number','LIKE','%'.$whatsapp_number.'%')->count();
    ...
    public function storeCustomer(Request $request)
    {
        ...
        if($customer_data['pos'])
            ...
            return redirect('customer')->with('create_message', $fullMessage);
    }
    ...
    function delete_black_list_customer($id) {
        BlackListCustomer::where('customer_id', $id)->delete();
        return redirect('customers/black-list-customers')->with('not_permitted','Data deleted Successfully');
    }
